...
class proc_txtreader:
    ...
    def __init__(self, name='thread', id='0', runMode='debug', 
        micDev='0', path='qPath_a_STT', ):

        self.runMode   = runMode
        self.micDev    = micDev
        self.path      = path
        if   (path == 'qPath_a_STT'):
             self.path = qPath_a_STT
        elif (path == 'qPath_a_TRA'):
             self.path = qPath_a_TRA
...
if __name__ == '__main__':
    ...
    sttreader_thread = proc_txtreader('sttreader', '0', path=qPath_a_STT, )
    sttreader_thread.start()
    trareader_thread = proc_txtreader('trareader', '0', path=qPath_a_TRA, )
