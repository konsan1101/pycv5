...
qPython_voice2wav  = '_v4__speech_voice2wav.py'
qPython_playVoice  = '_v4__speech_playvoice.py'
qPython_vision     = '_v4__vision_capture.py'
...
qPython_selfcheck  = '_v4_sub_self_check.py'
qPython_smartSpk   = '_v4_sub_smart_speaker.py'
qPython_rssSearch  = '_v4_sub_rss_search.py'
qPython_weather    = '_v4_sub_weather_search.py'
...
def main_init(runMode, micDev, ):
    ...
    qFunc.statusSet(qCtrl_bgm,       False )
    qFunc.statusSet(qCtrl_browser,   False )
    qFunc.statusSet(qCtrl_chatting,  False )
    qFunc.statusSet(qCtrl_knowledge, False )
    qFunc.statusSet(qCtrl_vision,    False )
    qFunc.statusSet(qCtrl_recognize, False )
    qFunc.statusSet(qCtrl_translate, False )
